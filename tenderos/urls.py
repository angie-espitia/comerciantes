...
urlpatterns = [
    ...
    re_path('compras/reportes/gastos/(?P<pk>\d+)/', view_de_reportes_gastos, name='view_de_reportes_gastos'),
    re_path('compras/reportes/gastos/lista/(?P<pk>\d+)/', list_compras_reportes_gastos, name='list_compras_reportes_gastos'),
    ...
    re_path('ventas/reportes/ganancias/(?P<pk>\d+)/', view_de_reportes_ganancias, name='view_de_reportes_ganancias'),
    re_path('ventas/reportes/ganancias/lista/(?P<pk>\d+)/', list_ventas_reportes_ganancias, name='list_ventas_reportes_ganancias'),
